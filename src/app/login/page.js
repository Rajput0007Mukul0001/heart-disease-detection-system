      ...
      <section className="min-h-screen flex items-stretch text-white">
        ...
        >
          ...
          <div className="w-full py-6 z-20">
            <h1 className="my-6  font-extrabold text-lg ">
            Welcome Home 
            </h1>
            ...
            <div className="py-6 space-x-7">
              ...
              <span className="w-10 h-10 inline-flex items-center justify-center rounded-full font-bold text-lg border-2 border-white">G+</span>
            ...
            {/* Form Section */}
            <p className="text-gray-100">Or use email to sign in to your account:</p>
            <form action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
              ...
              <div className="px-4 pb-2 pt-4">
                <button className="uppercase block w-full p-4 text-lg rounded-full
